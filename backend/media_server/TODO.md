...
## Sprint 3 - Backend — Servidor de Medios (ExpressJS)

- [x] Implementar endpoint de subida (sin procesamiento).
- [x] Guardar físicamente los archivos.
- [x] Devolver ID temporal del vídeo.
